...
import { getAuditLogs, getRefInfo, type HistoryEntry } from "./api/audit-logs.api";
import { AuditLogTable } from "./components/audit-log-table";
import { AuditLogDetailModal } from "./components/audit-log-detail-modal";
import { getStoredUser } from "@/lib/user";
import { Search, History, Trash2, Edit, PlusCircle, ShieldCheck, Users } from "lucide-react";
...
export default function AuditLogsPage() {
    ...
    const stats = useMemo(() => {
        return {
            ...
            customers: entries.filter(e => getRefInfo(e).type === "CUSTOMER").length,
                ...
                <div className="mx-auto max-w-7xl">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-5 gap-4 mb-8">
                        <div className="bg-white p-6 rounded-2xl shadow-sm border border-orange-50 relative overflow-hidden group">
                            ...
                            <p className="text-[10px] font-black uppercase tracking-widest text-orange-500 mb-2">Tổng</p>
                        ...
                        <div className="bg-white p-6 rounded-2xl shadow-sm border border-blue-50 relative overflow-hidden group">
                            ...
                            <p className="text-[10px] font-black uppercase tracking-widest text-blue-500 mb-2">Giao dịch</p>
                        ...
                        <div className="bg-white p-6 rounded-2xl shadow-sm border border-pink-50 relative overflow-hidden group">
                            ...
                            <p className="text-[10px] font-black uppercase tracking-widest text-pink-500 mb-2">Khách hàng</p>
                            <p className="text-3xl font-black text-charcoal">{stats.customers}</p>
                        </div>
                        <div className="bg-white p-6 rounded-2xl shadow-sm border border-emerald-50 relative overflow-hidden group">
                            ...
                            <p className="text-[10px] font-black uppercase tracking-widest text-emerald-500 mb-2">Kho hàng</p>
                        ...
                        <div className="bg-white p-6 rounded-2xl shadow-sm border border-purple-50 relative overflow-hidden group">
                            ...
                            <p className="text-[10px] font-black uppercase tracking-widest text-purple-500 mb-2">Quyền hạn</p>
                        ...
                        {!isPending && filteredEntries.length > 0 && (
                            <div className="flex flex-wrap items-center justify-between gap-4 border-t border-[#f3ebe7] p-4 bg-gray-50/30">
                                <p className="shrink-0 text-xs text-[#a07f6b]">
                                    Hiển thị {filteredEntries.length === 0 ? 0 : (currentPage - 1) * pageSize + 1} -{" "}
                                    {Math.min(currentPage * pageSize, filteredEntries.length)} của {filteredEntries.length} hoạt động
                                </p>
